...
class TestBooksCollector:
    ...
    def test_add_new_book_not_add_invalid_book(self, collector, name):
        collector.add_new_book(name)
        assert len(collector.get_books_genre()) == 0

    def test_set_book_genre_genre_set_for_book(self, collector):
    ...
    def test_set_book_genre_not_set_invalid_genre(self, collector):
        collector.add_new_book('Кыца убийца')
    ...
    def test_get_books_with_specific_genre_returns_correct_count(self, collector, genre, expected_count):
        collector.add_new_book('Кыца убийца')
        collector.add_new_book('Гордость и предубеждение и зомби')
        collector.add_new_book('Что делать, если ваш кот хочет вас убить')
        collector.set_book_genre('Кыца убийца', 'Комедии')
    ...
    def test_add_book_in_favorites_add_two_favorite_books(self, collector):
        collector.add_new_book('Кыца убийца')
        collector.add_new_book('Гордость и предубеждение и зомби')
    ...
    def test_add_book_in_favorites_not_add_duplicate_book(self, collector):
        collector.add_new_book('Кыца убийца')
        collector.add_new_book('Кыца убийца')
        collector.add_book_in_favorites('Кыца убийца')
        assert len(collector.get_list_of_favorites_books()) == 1

    def test_add_book_in_favorites_not_add_book_not_in_book_genre(self, collector):
        collector.add_book_in_favorites('Кыца убийца')
    ...
    def test_delete_book_from_favorites_not_delete_invalid_book(self, collector):
        collector.add_new_book('Кыца убийца')
        collector.add_book_in_favorites('Кыца убийца')
    ...
    def test_get_books_genre_returns_current_dictionary(self, collector):
        ...
        assert collector.get_books_genre() == {'Кыца убийца': 'Комедии'}
